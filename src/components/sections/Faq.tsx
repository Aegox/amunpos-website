...
export default function Faq() {
  return (
    <section id="Faq" className="flex w-full scroll-mt-[72px] flex-col items-center px-5 py-20 lg:py-28">
      <span className="inline-flex items-center gap-1.5 rounded-full border border-brand-200 bg-brand-50 px-3 py-1.5 text-label-sm text-primary-dark">
        <RiQuestionLine className="size-3.5" />
        ¿Tienes alguna pregunta?
      </span>
      <h2 className="mt-5 max-w-xl text-center text-title-h3 text-strong-950 lg:text-title-h2">Aquí hay algunas respuestas</h2>
