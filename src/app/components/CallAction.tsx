  ...
  return (
    <section className="relative flex justify-center py-10 w-full px-3 lg:px-0 lg:h-[550px]">
      <div className="z-50 relative flex flex-col items-center justify-center bg-[var(--heading-color)] rounded-3xl 2xl:w-[78%] lg:w-[85%] h-full px-5 py-24 lg:pt-[90px] lg:pb-[100px] lg:px-[40px]">
        <Image src="/Ellipse_small.svg" layout="fill" objectFit="contain" className="w-1/6 absolute top-0 right-0" alt="a shape of call action component" />
        <Image src="/stroke.svg" layout="fill" objectFit="contain" className="w-1/5 absolute bottom-0 left-0" alt="a shape of call action component" />
