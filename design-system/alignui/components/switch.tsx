// Fuente: https://alignui.com/docs/v1.2/ui/switch (código real, verbatim)
    ...
    >
      ...
      >
        <SwitchPrimitives.Thumb
          ...
          style={{
            ['--mask' as any]: 'radial-gradient(circle farthest-side at 50% 50%, #0000 1.95px, #000 2.05px 100%) 50% 50%/100% 100% no-repeat',
          }}
        />
      </div>
    </SwitchPrimitives.Root>
...
/*
  Dimensiones exactas:
  - Root: h-5 w-8 (20 x 32px)
  - Track: h-4 w-7 (16 x 28px), rounded-full
  - Thumb: size-3 (12x12px), en disabled size-2.5 (10x10px)
  - Traslación al activar: translate-x-3 (12px)
  El "before"/"after" del thumb son dos capas: una máscara radial-gradient que
  recorta un círculo perfecto (para que el thumb no dependa de rounded-full +
  overflow) y una sombra aparte (shadow-switch-thumb) para el volumen 3D.
*/
